...
-A  Output in "alphabetic format", which looks like this:
    ...
    It means: 4 atoms and 3 bonds.  The atoms are numbered
    in the order they appear in the name 0=C, 1=C, 2=O, 3=O.
    Then the bonds are listed with "-" for single, "=" for
    double and "#" for triple.
